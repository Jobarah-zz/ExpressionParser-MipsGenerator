...
{
  "$end", "error", "$undefined", "ID", "LIT_INT", "TK_EOF", "TK_ERROR",
  "\"+\"", "\"*\"", "\"-\"", "\"(\"", "\")\"", "$accept", "input",
  "ExprList", "E", "T", "F", YY_NULLPTR
};
#endif
...
{
       1,     2,    12,    12,    13,    13,    15,     3,     9,    10,
      11,    16,    17,     0,    14,    18
};

static const yytype_int8 yycheck[] =
{
       3,     4,     7,     7,     9,     9,    11,    10,     3,     0,
       5,    12,    13,    -1,     8,    14
};
